...
import { join, normalize, dirname, resolve, extname, relative, basename } from 'pathe';
...
function extractExportFilenames(exports, conditions = []) {
  ...
  return Object.entries(exports).flatMap(
    ([condition, exports2]) => typeof exports2 === "string" ? { file: exports2, type: inferExportType(condition, conditions, exports2) } : extractExportFilenames(exports2, [...conditions, condition])
  );
}
